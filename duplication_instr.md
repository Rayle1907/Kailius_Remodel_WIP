# Gauntlet Duplication Instructions

This is the project-local memory for duplicating gauntlet scenes without breaking Android boot, menu loading, mobile controls, or enemy cleanup. For the full build/install/debug workflow, read `apk build instructions.md`.
